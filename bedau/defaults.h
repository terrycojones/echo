...
/* BEDAU: */
#define DEF_UPDATE_ON_TESTING         TRUE
#define DEF_UPDATE_ON_SUCCESS         FALSE
#define DEF_UPDATE_COMBAT             TRUE
#define DEF_UPDATE_TRADING            TRUE
#define DEF_UPDATE_MATING             TRUE
#define DEF_GENES_TO_DUMP             ""
#define DEF_DUMP_SPECIES              FALSE
#define DEF_SUM_OVER_GENES            TRUE
