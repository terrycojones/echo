...
char *object_location;
{
    ...
    popup_widget(0, population_graph->popup, 0);
...
Widget top;
{
    ...
    population_graph = create_plotter("Worldwide Population Level", "Time", "Level", "populationGraph", 200, 100, 0.0, 200.0, 0.0, 200.0, top, 1);
    species_graph = create_plotter("Species Level", "Time", "Level", "speciesGraph", 200, 100, 0.0, 200.0, 0.0, 200.0, top, 1);
    resources_graph = create_plotter("Resource Levels", "Time", "Level", "resourcesGraph", 200, 100, 0.0, 200.0, 0.0, 400.0, top, 1);
    schema_graph = create_plotter("Schema Level", "Time", "Level", "schemaGraph", 200, 100, 0.0, 200.0, 0.0, 100.0, top, 1);
    variant_graph = create_plotter("Variant Levels", "Time", "Level", "variantGraph", 200, 100, 0.0, 200.0, 0.0, 100.0, top, 1);
