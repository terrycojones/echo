/* $Header: /tmp_mnt/vida/disks/disk5/Users/terry/r/echo/RCS/types.h,v 1.8 1992/11/16 07:05:45 terry Exp terry $ */
...
typedef struct {
...
#ifndef NO_MIGRATION
    char migration[NMIGRATION_BITS + 1];
    BOOLEAN has_migrated;
#endif
    ...
    int time_since_replication;           /* Haas model only. */
...
#ifndef NO_MIGRATION
#define AGENT_HAS_MIGRATED(agent)              ((agent)->has_migrated)
#define AGENT_MIGRATION(agent)                 ((agent)->migration)
#define AGENT_MIGRATION_BIT(agent, i)          ((agent)->migration[i])
#endif
#ifndef NO_SELF_REPLICATION
#define AGENT_TIME_SINCE_REPLICATION(agent)    ((agent)->time_since_replication)
