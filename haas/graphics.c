...
Widget top;
{
    ...
    population_graph = create_plotter("Worldwide Population Level", "Time", "Level", "populationGraph", 200, 100, 0.0, 200.0, 0.0, 200.0, top, 0);
    species_graph = create_plotter("Species Level", "Time", "Level", "speciesGraph", 200, 100, 0.0, 200.0, 0.0, 200.0, top, 0);
    resources_graph = create_plotter("Resource Levels", "Time", "Level", "resourcesGraph", 200, 100, 0.0, 200.0, 0.0, 400.0, top, 0);
    schema_graph = create_plotter("Schema Level", "Time", "Level", "schemaGraph", 200, 100, 0.0, 200.0, 0.0, 100.0, top, 0);
    variant_graph = create_plotter("Variant Levels", "Time", "Level", "variantGraph", 200, 100, 0.0, 200.0, 0.0, 100.0, top, 0);
...
Widget top;
{
    ...
    i = 0;
    XtSetArg(args[i], XtNlabel, "Migration Viewer");               i++;
    entry = XtCreateManagedWidget("mutationViewer", smeBSBObjectClass, schema_menu_widgets.menu, args, i);
    XtAddCallback(entry, XtNcallback, call_mut_viewer, (XtPointer) NULL);

    i = 0;
    XtSetArg(args[i], XtNlabel, "Resource Viewer");               i++;
    entry = XtCreateManagedWidget("resourceViewer", smeBSBObjectClass, schema_menu_widgets.menu, args, i);
    XtAddCallback(entry, XtNcallback, call_res_viewer, (XtPointer) NULL);
#endif
